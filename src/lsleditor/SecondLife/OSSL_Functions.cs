...
namespace LSLEditor
{
    ...
    public partial class SecondLife
    {
        ...
        public void osDetectedCountry(integer index)
        {
            Verbose("osDetectedCountry(\"{0}\")", index);
        }
        ...
        public void osGetAgentCountry(key avatarID)
        {
            Verbose("osGetAgentCountry(\"{0}\")", avatarID);
        }
        ...
        {
            Verbose("osSetOwnerSpeed(\"{0}\")", SpeedModifier);
        }
        ...
        public void osReplaceAgentEnvironment(key agentKey, integer transition, string daycycle)
        {
            Verbose("osReplaceAgentEnvironment(\"{0}\", {1}, {2})", agentKey, transition, daycycle);
        }
        ...
        public void osNpcSayTo(key npc, key target, integer channel, string message)
        {
            Verbose("osNpcSay(\"{0}\", {1}, {2}, \"{3}\")", npc, target, channel, message);
            Chat(channel, message, CommunicationType.Say);
        }
        ...
        public void osClearObjectAnimations()
        {
            Verbose("osClearObjectAnimations()");
        }
        ...
        public void osLocalTeleportAgent(key agentID, vector newPosition, vector newVelocity, vector newLookat, integer optionFlags)
        {
            Verbose("osSetProjectionParams(\"{0}\", {1}, \"{2}\", {3}, {4}", agentID, newPosition, newVelocity, newLookat, optionFlags);
        }
        ...
        //
        // NEW NEW NEW Please fill me up
        //

        //Prim

        public void osGetInventoryItemKey(string name)
        {
            Verbose("osGetInventoryItemKey({0})", name);
        }

        public void osGetInventoryName(key itemId)
        {
            Verbose("osGetInventoryName({0})", itemId);
        }

        public void osGetInventoryLastOwner(string itemName_or_itemId)
        {
            Verbose("osGetInventoryLastOwner({0})", itemName_or_itemId);
        }

        public void osGetLastChangedEventKey()
        {
            Verbose("osGetLastChangedEventKey()=0");
            return;
        }

        public void osGetSitActiveRange()
        {
            Verbose("osGetSitActiveRange()=0");
            return;
        }

        public void osGetLinkSitActiveRange(integer linkNumber)
        {
            Verbose("osGetLinkSitActiveRange({0})", linkNumber);
        }

        public void osGetStandTarget()
        {
            Verbose("osGetStandTarget()=0");
            return;
        }

        public void osGetLinkStandTarget(integer linkNumber)
        {
            Verbose("osGetLinkStandTarget({0})", linkNumber);
        }

        public void osSetSitActiveRange(float range)
        {
            Verbose("osSetSitActiveRange({0})", range);
        }

        public void osSetLinkSitActiveRange(integer linkNumber, float range)
        {
        }

        public void osSetStandTarget(vector feetTarget)
        {
            Verbose("osSetStandTarget({0})", feetTarget);
        }

        public void osSetLinkStandTarget(integer linkNumber, vector feetTarget)
        {
        }
        ...
        public void osGetParcelDwell(vector pos)
        {
            Verbose("osGetParcelDwell({0})", pos);
        }

        //Region / Parcel Environment

        public void osGetApparentTime()
        {
            Verbose("osGetApparentTime()=0");
            return;
        }

        public void osGetApparentTimeString(integer format24)
        {
        }

        public void osGetApparentRegionTime()
        {
            Verbose("osGetApparentRegionTime()=0");
            return;
        }

        public void osGetApparentRegionTimeString(integer format24)
        {
        }
        ...
        public void osGetSimulatorMemoryKB()
        {
            Verbose("osGetSimulatorMemoryKB()=0");
            return;
        }
        ...
        {
            Verbose("osSetParcelMusicURL({0})", url);
        }

        //Script

        public void osResetAllScripts(integer AllLinkSet)
        {
            Verbose("osResetAllScripts({0})", AllLinkSet);
        }
        ...
        public void osGetPSTWallclock()
        {
            Verbose("osGetPSTWallclock()=0");
            return;
        }

        public void osIsNotValidNumber(float d)
        {
            Verbose("osIsNotValidNumber({0})", d);
        }
